...
function connect(url, socketOptions) {
  ...
  // Extend Options, allowing override of clientProperties and such.
  deepExtend( options, socketOptions );

  var port = parts.port || ((protocol === 'amqp:') ? 5672 : 5671);

  // Allow extended optiosn to override host and port.
  sockopts.host = options.host || parts.hostname;
  sockopts.port = options.port || parseInt(port);

  // console.log( 'options', options );
  // console.log( 'sockopts', sockopts );
